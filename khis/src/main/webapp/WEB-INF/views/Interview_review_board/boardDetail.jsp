	...
	<div class="board-container">
		...
		<div class="content">
            ...
            <div class="comment-list" data-board-no="${board.BOARD_NO}">
              [댓글<span id="toc-toggle-count"></span>개]<span id="toc-toggle"> 보기</span> <br /><br />
              <div id="toc-content">  
                <input type="checkbox" class="secretBtn" value="commentSecretYN"> 
                <label class="secretlb">[비밀댓글]</label>
                <br />
                <input class="comment-input" type="text" placeholder="20글자 내로 적어주세요.:)" name="commentsTitle">
                <button class="add" type="button" style="border: none; outline: none;">등록</button>
              </div>
            </div>
          </div>
				</div>
